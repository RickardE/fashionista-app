  ...
  return (
    <div className="animate-rise flex h-dvh flex-col px-[30px] pb-10">
      <div className="flex flex-1 flex-col justify-center pb-5">
        <div className="mb-[22px] text-[9px] font-semibold tracking-[0.24em] text-neutral-700 uppercase">
          Welcome
        </div>
        ...
        <p className="mt-5 max-w-[26ch] text-[14px] leading-[1.65] text-neutral-700 text-pretty">
      ...
      <div className="mt-4 text-[11px] leading-[1.5] text-neutral-700">
